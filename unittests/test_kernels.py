...
class Test_cspyce1_kernels(unittest.TestCase):
    ...
    def test_dpgrdr_drdpgr(self):
        ...
        self.assertAllEqual(drdpgr('saturn', 1., 0., 0., 1., 0.),
                            [[-0.84147098, 0., 0.54030231],
                             ...
                             [0., 1., 0.]], 5e-9)
        self.assertEqual(dpgrdr_vector('saturn', 1., 0., [1, 2, 3, 4], 1., 0.).shape,
                         (4, 3, 3))
        self.assertEqual(
            drdpgr_vector('saturn', 1., 0., 0., 1., [0.1, 0.02, 0.03, 0.04]).shape, (4, 3, 3))
    ...
    def test_illum_illumf_illumg_ilumin_phaseg(self):
        CASSINI_ET = 17.65 * 365.25 * 86400.
    ...
    def test_sce2c_sce2s_sce2t_scdecd_sct2e_scencd_scs2e_sctiks_scfmt_scpart(self):
        CASSINI_ET = 17.65 * 365.25 * 86400.
        CASSINI_ET2 = CASSINI_ET + 86400.
    ...
    def test_spkssb_spkacs_spkapo_spkez_spkezr_spkpos(self):
        CASSINI_ET = 17.65 * 365.25 * 86400.
        CASSINI_ET2 = CASSINI_ET + 86400.
    ...
    def test_spkez_spkgeo_spkgps(self):
        CASSINI_ET = 17.65 * 365.25 * 86400.
        CASSINI_ET2 = CASSINI_ET + 86400.
