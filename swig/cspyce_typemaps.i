...
/*
 * A LOCAL_INOUT_ARRAY is similar to an INOUT_ARRAY, except that it will have been
 * generated by cspyce internally (typically cspyce1.py), so we don't need to verify it.
 * It will always be a numpy array of the right size, type, C-order, and readability
