...
%define VECTORIZE_2s_d_s_2b_dX_2s__dN_d(NAME, FUNC, N)
...
%define VECTORIZE_3d_2b__dN(NAME, FUNC, N)
...
%define VECTORIZE_3d__RETURN_d(NAME, FUNC)
...
%define VECTORIZE_d_di__RETURN_i(NAME, FUNC)
...
%define VECTORIZE_di_dX_d__2d(NAME, FUNC)
...
%define VECTORIZE_di_dX_d__d(NAME, FUNC)
...
%define VECTORIZE_i_d_dXY__i_b(NAME, FUNC)
...
%inline %{
    void NAME ## _vector(
        ...
        *bool1 = NULL; *bool1_dim1 = 0;
        ...
        SpiceInt *int1_buffer = my_int_malloc(size, my_name);
        SpiceBoolean *bool1_buffer = int1_buffer ? my_bool_malloc(size, my_name) : NULL;
        if (!bool1_buffer) {
            free(int1_buffer);
            return;
        }
...
%define VECTORIZE_3d_2b__dMN(NAME, FUNC, M, N)
...
%define VECTORIZE_dX_3d__dM_dN_b(NAME, FUNC, M, N)
...
%define VECTORIZE_dX_3d__dN(NAME, FUNC, N)
...
%define VECTORIZE_d_dX_dY__dN(NAME, FUNC, N)
...
%define VECTORIZE_2d_di_d__2d(NAME, FUNC)
...
%define VECTORIZE_di_dij_d__2d(NAME, FUNC)
...
%define VECTORIZE_2d_di_d__RETURN_d(NAME, FUNC)
...
%define VECTORIZE_di_di_d__2d(NAME, FUNC)
...
%define VECTORIZE_di_di_d__RETURN_d(NAME, FUNC)
...
%define VECTORIZE_s_d_3s_dX_2s__dN_d(NAME, FUNC, N)
...
%define VECTORIZE_dX_2s_d_4s__dN_d(NAME, FUNC, N)
...
%define VECTORIZE_s_d_3s_dX_d_2s__dN_d(NAME, FUNC, N)
...
%define VECTORIZE_dX_d_2s_d_4s__dN_d(NAME, FUNC, N)
...
%define VECTORIZE_2s_d_5s_dX__dN_2d_dN_d_dN(NAME, FUNC, N, N, N)
...
%inline %{
    void NAME ## _vector(
        ...
        *out23 = NULL; *out23_dim1 = 0; *out23_dim2 = N;
        ...
        SpiceDouble *out12_buffer = out11_buffer ? my_malloc(size, my_name) : NULL;
        SpiceDouble *out22_buffer = out12_buffer ? my_malloc(size * N, my_name) : NULL;
        SpiceDouble *out13_buffer = out22_buffer ? my_malloc(size, my_name) : NULL;
        SpiceDouble *out23_buffer = out13_buffer ? my_malloc(size * N, my_name) : NULL;
        if (!out23_buffer) {
            free(out21_buffer);
            free(out11_buffer);
            free(out12_buffer);
...
%define VECTORIZE_d_8s__RETURN_d(NAME, FUNC)
